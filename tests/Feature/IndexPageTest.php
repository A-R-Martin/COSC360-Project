...
class IndexPageTest extends TestCase
{
    ...
    public function test_guest_sees_signin_and_signup_links(): void
    {
        ...
        $this->assertStringNotContainsString('My Profile', $body);
    }

    public function test_logged_in_user_sees_profile_and_catalog_links(): void
    {
        ...
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertStringContainsString('My Profile', $body);
        $this->assertStringContainsString('Browse Books', $body);
